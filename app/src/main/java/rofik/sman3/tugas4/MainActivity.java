...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Integer[] foto = {R.drawable.ahmad_dahlan, R.drawable.ahmad_yani, R.drawable.bung_tomo, R.drawable.gatot_subroto, R.drawable.ki_hadjar_dewantara, R.drawable.mohammad_hatta,
        R.drawable.sudirman, R.drawable.sukarno, R.drawable.supomo, R.drawable.tan_malaka};

        String[] names_of_heroes = {"Ahmad Dahlan", "Ahmad Yani", "Bung Tomo", "Gatot Subroto", "Ki Hajar Dewantara", "Mohammad Hatta"
        , "Sudirman", "Soekarno", "Soepomo", "Tan Malaka"};
        ...
        for (int i = 0; i<foto.length; i++) {
            Hero hero = new Hero(foto[i], names_of_heroes[i], heroDetails[i]);
            heroes.add(hero);
        }
        ...
        //inisialisasi heroAdapter
        heroAdapter = new HeroAdapter(heroes);
        ...
        TransitionDrawable trans1 = (TransitionDrawable) res.getDrawable(R.drawable.transition);
